...
namespace Steckbrett.SpecsSupport.Specs.Features
{
    ...
    public partial class AutoPocoGenerationFeature
    {
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "AutoPoco generation", "In order to be the greatest lazy developer\nAs a lazy developer using SpecFlow\nI w" +
                    "ant to automagically generate random object instances", new string[] {
                        "model_mapping"});
