...
namespace Steckbrett.SpecsSupport.Specs.Features
{
    ...
    public partial class AutoMapperGenerationFeature
    {
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "AutoMapper generation", "In order to create beautiful feature specifications\r\nAs a developer using SpecFlo" +
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Mapping from file taking all rows using -1 convention # This is useful in a scena" +
            "rio outline")]
        public virtual void MappingFromFileTakingAllRowsUsing_1ConventionThisIsUsefulInAScenarioOutline()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Mapping from file taking all rows using -1 convention # This is useful in a scena" +
                    "rio outline", ((string[])(null)));
            this.ScenarioSetup(scenarioInfo);
